...
def main(input_filename):
 ...
 ############################################################
    ...
    #open video file
    cap = cv2.VideoCapture('data/jungle2.mp4')
    ...
    while(cap.isOpened()):
        ...
        if writer is None:
            ...
            writer = cv2.VideoWriter('data/output-jungle2.avi', cv2.VideoWriter_fourcc(*'XVID'), 30, frame_size)
